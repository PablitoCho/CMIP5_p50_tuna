...
data<-read.table("~/Code/Projects/CMIP5_p50/sh/Mean_AllModels/Species_global4.csv", sep=",")
colnames(data)<-c("species", "p50", "deltaH")

#quartz()
OutGraph<-paste("~/Code/Projects/CMIP5_p50/graphs/compare_p50_v2.ps", sep="")
...
#quartz()
OutGraph<-paste("~/Code/Projects/CMIP5_p50/graphs/compare_deltaH_v2.ps", sep="")
postscript(OutGraph, family="Helvetica", width=6, height=6)
