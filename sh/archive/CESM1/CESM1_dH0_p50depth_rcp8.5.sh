...
do
  ...
  mkdir /Data/Projects/CMIP5_p50/CESM1/${species}
  mkdir /Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0	
  mkdir /Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0/p50
  mkdir /Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0/p50depth

  echo "SET DATA \"/Data/CMIP5/climdiff/WOA_modeldiff_rcp8.5/CESM1_rcp8.5_po2.nc\", \"/Data/CMIP5/climdiff/WOA_modeldiff_rcp8.5/CESM1_rcp8.5_temp.nc\"" >p50depth.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0/p50/cesm1.rcp85.p50.${species}.nc\"/LLIMITS=1:12/L=1 p50" >> p50depth.jnl

  echo "repeat/L=2:12 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0/p50/cesm1.rcp85.p50.${species}.nc\"/L=\`l\` p50)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0/p50depth/cesm1.rcp85.p50depth.${species}.nc\"/LLIMITS=1:12/L=1 p50depth" >> p50depth.jnl

  echo "repeat/L=2:12 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0/p50depth/cesm1.rcp85.p50depth.${species}.nc\"/L=\`l\` p50depth)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0/p50/cesm1.rcp85.p50av.${species}.nc\" p50av" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/temp_deltaH0/p50depth/cesm1.rcp85.p50depthav.${species}.nc\" p50depthav" >> p50depth.jnl
