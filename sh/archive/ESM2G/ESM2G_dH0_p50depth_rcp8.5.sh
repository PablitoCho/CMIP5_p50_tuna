...
do
  ...
  mkdir /Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0	
  mkdir /Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0/p50
  mkdir /Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0/p50depth
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0/p50/esm2g.rcp85.p50.${species}.nc\"/LLIMITS=1:12/L=1 p50" >> p50depth.jnl

  echo "repeat/L=2:12 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0/p50/esm2g.rcp85.p50.${species}.nc\"/L=\`l\` p50)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0/p50depth/esm2g.rcp85.p50depth.${species}.nc\"/LLIMITS=1:12/L=1 p50depth" >> p50depth.jnl

  echo "repeat/L=2:12 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0/p50depth/esm2g.rcp85.p50depth.${species}.nc\"/L=\`l\` p50depth)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0/p50/esm2g.rcp85.p50av.${species}.nc\" p50av" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/temp_deltaH0/p50depth/esm2g.rcp85.p50depthav.${species}.nc\" p50depthav" >> p50depth.jnl
