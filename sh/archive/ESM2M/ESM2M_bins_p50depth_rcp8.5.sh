...
do
      ...
      echo "SET DATA \"/Data/Projects/CMIP5_p50/ESM2M/${species}/p50depth/esm2m.rcp85.2081-2100.p50depth.${species}.nc\", \"/Data/CMIP5/climdiff/WOA_modeldiff_rcp8.5/ESM2M_rcp8.5_temp.nc\"" > binstats.jnl
