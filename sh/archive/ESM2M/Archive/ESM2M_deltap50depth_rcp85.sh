...
#  echo "list/nohead/file=\"/Users/kasmith/Dropbox/Manuscripts/CMIP5_p50/Results/ESM2M/ESM2M.rcp85.p50depthav.geostats.txt\"/format=tab/append \"${species}\", ${p50}, ${deltaH}, mask1[d=1, x=@din, y=@din], mask2[d=2, x=@din, y=@din], mask3[d=3, x=@din, y=@din], mask4[d=4, x=@din, y=@din], delta_p50depth[x=@ave, y=@ave], delta_p50depth[x=@var, y=@var]^0.5" >> deltap50depth.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2M_Blood/${species}/ESM2M.rcp85.deltap50depth.${species}.nc\" delta_p50depth" >> deltap50depth.jnl
