...
do
  ...
  mkdir /Data/Projects/CMIP5_p50/ESM2M/${species}/p50
  mkdir /Data/Projects/CMIP5_p50/ESM2M/${species}/p50depth

  echo "SET DATA \"/Data/CMIP5/climdiff/WOA_modeldiff_rcp8.5/ESM2M_rcp8.5_po2.nc\", \"/Data/CMIP5/climdiff/WOA_modeldiff_rcp8.5/ESM2M_rcp8.5_temp.nc\"" >p50depth.jnl
