...
do
  ...
  echo "SET DATA \"/Data/Projects/CMIP5_p50/IUCN/nc/IUCN_${species}.nc\", \"/Data/Projects/CMIP5_p50/modelmean/modelmean.deltap50depth.${species}.nc\""  > maskP50depthav.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/IUCN_modelmean/IUCN.modelmean.deltap50depth.${species}.nc\" geogdeltaP50" >> maskP50depthav.jnl
