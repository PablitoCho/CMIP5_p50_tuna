...
do
      rm /Data/Projects/CMIP5_p50/ESM2M/${species}/P50Depthav_geostats_historical.txt

      echo "SET DATA \"/Data/CMIP5/ESM2M/processed/historical/ocean.1981-2000.temp.nc\", \"/Data/CMIP5/ESM2M/processed/historical/esm2m.1981-2000.po2.nc\", \"/Data/Projects/CMIP5_p50/ESM2M/${species}/ESM2M.rcp85.deltap50depth.${species}.nc\"" > geostats.jnl
      ...
      echo "list/clobber/nohead/file=\"/Data/Projects/CMIP5_p50/ESM2M/${species}/P50Depth_geostats_historical.txt\"/format=tab/append ocean[x=@din, y=@din, k=1], p50depth_area[x=@din, y=@din], p50depth[x=@ave, y=@ave], p50depth[x=@var, y=@var], p50depth[x=@ngd, y=@ngd]" >> geostats.jnl

      echo "list/nohead/file=\"/Data/Projects/CMIP5_p50/ESM2M/P50Depthav_geostats.txt\"/format=tab/append \"historical\", \"${species}\", ${p50}, ${deltaH}, oceanav[x=@din, y=@din, k=1], p50depthav_area[x=@din, y=@din], p50depthav[x=@ave, y=@ave], p50depthav[x=@var, y=@var], p50depthav[x=@ngd, y=@ngd], p50depthav2[x=@din, y=@din]" >> geostats.jnl
