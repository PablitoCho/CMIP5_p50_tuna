...
do
  ...
  echo "SET DATA \"/Data/CMIP5/ESM2M/processed/historical/ocean.1981-2000.temp.nc\", \"/Data/CMIP5/ESM2M/processed/historical/esm2m.1981-2000.po2.nc\"" > p50depth.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/BloodOxygenBinding/ESM2M_Blood/${species}/p50/esm2m.1981-2000.p50.${species}.nc\"/LLIMITS=1:20/L=1 p50" >> p50depth.jnl

  echo "repeat/L=2:20 (SAVE/APPEND/FILE=\"/Data/Projects/BloodOxygenBinding/ESM2M_Blood/${species}/p50/esm2m.1981-2000.p50.${species}.nc\"/L=\`l\` p50)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/BloodOxygenBinding/ESM2M_Blood/${species}/p50depth/esm2m.1981-2000.p50depth.${species}.nc\"/LLIMITS=1:20/L=1 p50depth" >> p50depth.jnl

  echo "repeat/L=2:20 (SAVE/APPEND/FILE=\"/Data/Projects/BloodOxygenBinding/ESM2M_Blood/${species}/p50depth/esm2m.1981-2000.p50depth.${species}.nc\"/L=\`l\` p50depth)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/BloodOxygenBinding/ESM2M_Blood/${species}/p50av/esm2m.1981-2000.p50av.${species}.nc\" p50av" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/BloodOxygenBinding/ESM2M_Blood/${species}/p50depthav/esm2m.1981-2000.p50depthav.${species}.nc\" p50depthav" >> p50depth.jnl
