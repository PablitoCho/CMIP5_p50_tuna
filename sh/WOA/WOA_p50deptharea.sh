...
do
      ...
      echo "list/clobber/nohead/file=\"/Data/Projects/CMIP5_p50/WOA/WOA_p50depthav_area.txt\"/format=tab/append \"WOA\", \"${species}\", ${p50}, ${deltaH}, ocean[x=@din, y=@din, k=1], p50deptharea[x=@din, y=@din], p50depthav[x=@ave, y=@ave], p50depthav[x=@var, y=@var], p50depthav[x=@ngd, y=@ngd]" >> geostats.jnl
