...
do
  ...
  echo "SET DATA \"/Data/CMIP5/ESM2M/processed/controls/esm2m.0281-0300.po2.nc\", \"/Data/Projects/CMIP5_p50/ESM2M_Blood/${species}/p50av/esm2m.0281-0300.p50av.${species}.nc\"" > depthdiffmin.jnl
...
echo "define att depthdiffmin.long_name = \"Depth of the Minimum Difference in Oxygen Pressure Between Blood and Environment\"" >> depthdiffmin.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2M_Blood/${species}/diffmin/esm2m.0281-0300.diffmin.${species}.nc\" diffmin" >> depthdiffmin.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2M_Blood/${species}/depthdiffmin/esm2m.0281-0300.depthdiffmin.${species}.nc\" depthdiffmin" >> depthdiffmin.jnl
