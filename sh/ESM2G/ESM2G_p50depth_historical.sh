...
do
  ...
  echo "SET DATA \"/Data/CMIP5/ESM2G/processed/historical/ocean_z.1981-2000.temp.nc\", \"/Data/CMIP5/ESM2G/processed/historical/esm2g.1981-2000.po2.nc\"" > p50depth.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/p50/esm2g.1981-2000.p50.${species}.nc\"/LLIMITS=1:20/L=1 p50" >> p50depth.jnl

  echo "repeat/L=2:20 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/p50/esm2g.1981-2000.p50.${species}.nc\"/L=\`l\` p50)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/p50depth/esm2g.1981-2000.p50depth.${species}.nc\"/LLIMITS=1:20/L=1 p50depth" >> p50depth.jnl

  echo "repeat/L=2:20 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/p50depth/esm2g.1981-2000.p50depth.${species}.nc\"/L=\`l\` p50depth)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/p50av/esm2g.1981-2000.p50av.${species}.nc\" p50av" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2G/${species}/p50depthav/esm2g.1981-2000.p50depthav.${species}.nc\" p50depthav" >> p50depth.jnl
