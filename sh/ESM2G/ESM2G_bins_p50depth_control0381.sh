...
do
      ...
      echo "SET DATA \"/Data/CMIP5/ESM2G/processed/controls/ocean_z.0381-0400.temp.nc\", \"/Data/CMIP5/ESM2G/processed/controls/esm2g.0381-0400.po2.nc\"" > binstats.jnl
      ...
      echo "list/clobber/nohead/file=\"/Data/Projects/CMIP5_p50/ESM2G/P50Depthav_bins.txt\"/format=tab/append \"control0381\", \"${species}\", ${p50}, ${deltaH}, depth0to100_area[x=@din, y=@din], depth100to200_area[x=@din, y=@din], depth200to300_area[x=@din, y=@din], depth300to400_area[x=@din, y=@din], depth400to500_area[x=@din, y=@din], depth500to600_area[x=@din, y=@din], depth600to700_area[x=@din, y=@din], depth700to800_area[x=@din, y=@din], depth800to900_area[x=@din, y=@din], depth900to1000_area[x=@din, y=@din]" >> binstats.jnl
