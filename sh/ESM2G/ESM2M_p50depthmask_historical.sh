...
do
  ...
  echo "SET DATA \"/Data/CMIP5/ESM2M/processed/historical/ocean.1981-2000.temp.nc\", \"/Data/CMIP5/ESM2M/processed/historical/esm2m.1981-2000.po2.nc\"" > p50depthmask.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/ESM2M_Blood/${species}/p50depthmask/esm2m.1981-2000.p50depthmask.${species}.nc\" p50depthmask" >> p50depthmask.jnl
