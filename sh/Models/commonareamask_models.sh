...
do
  ...
  echo "Let mask7 = DELTAP50DEPTHAV[d=7]*0+1" >> commonmask.jnl

  echo "Let maskall = mask1 * mask2 * mask3 * mask4 * mask5 * mask6 * mask7" >> commonmask.jnl
  ...
  echo "Let mask7_H0 = DELTAP50DEPTHAV_DELTAH0[d=7]*0+1" >> commonmask.jnl

  echo "Let maskall_H0 = mask1_H0 * mask2_H0 * mask3_H0 * mask4_H0 * mask5_H0 * mask6_H0 * mask7_H0" >> commonmask.jnl
