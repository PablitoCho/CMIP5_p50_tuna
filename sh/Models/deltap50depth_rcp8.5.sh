...
do
  mkdir /Data/Projects/CMIP5_p50/CESM1/${species}/deltap50depth

  echo "SET DATA \"/Data/Projects/CMIP5_p50/WOA/${species}/p50depth/woa.p50depth.${species}.nc\", \"/Data/Projects/CMIP5_p50/CESM1/${species}/p50depth/cesm1.rcp85.p50depth.${species}.nc\"" > deltap50depth.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/deltap50depth/cesm1.deltap50depth.${species}.nc\"/LLIMITS=1:12/L=1 deltap50depth" >> deltap50depth.jnl

  echo "repeat/L=2:12 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/deltap50depth/cesm1.deltap50depth.${species}.nc\"/L=\`l\` deltap50depth)" >> deltap50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/CESM1/${species}/deltap50depth/cesm1.deltap50depthav.${species}.nc\" deltap50depthav" >> deltap50depth.jnl
