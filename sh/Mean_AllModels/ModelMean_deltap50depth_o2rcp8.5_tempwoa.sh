...
do
  ...
  echo "SET DATA \"/Data/Projects/CMIP5_p50/cesm1/${species}/deltap50depth/cesm1.deltap50depthav.O2rcp85.TempWOA.${species}.nc\", \"/Data/Projects/CMIP5_p50/esm2g/${species}/deltap50depth/esm2g.deltap50depthav.O2rcp85.TempWOA.${species}.nc\", \"/Data/Projects/CMIP5_p50/esm2m/${species}/deltap50depth/esm2m.deltap50depthav.O2rcp85.TempWOA.${species}.nc\", \"/Data/Projects/CMIP5_p50/hadgem2/${species}/deltap50depth/hadgem2.deltap50depthav.O2rcp85.TempWOA.${species}.nc\", \"/Data/Projects/CMIP5_p50/ipsl/${species}/deltap50depth/ipsl.deltap50depthav.O2rcp85.TempWOA.${species}.nc\", \"/Data/Projects/CMIP5_p50/mpi/${species}/deltap50depth/mpi.deltap50depthav.O2rcp85.TempWOA.${species}.nc\", \"/Data/WOA/WOA_temp/temperature_monthly_5deg.nc\"" > modelmean.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/modelmean/modelmean.deltap50depth.O2rcp85.TempWOA.${species}.nc\" modelmean, signagree" >> modelmean.jnl


  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/modelmean/signagree.5deg.deltap50depth.O2rcp85.TempWOA.${species}.nc\" signagree_5deg" >> modelmean.jnl
