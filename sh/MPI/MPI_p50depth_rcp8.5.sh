...
do
  ...
  mkdir /Data/Projects/CMIP5_p50/MPI/${species}	
  mkdir /Data/Projects/CMIP5_p50/MPI/${species}/p50
  mkdir /Data/Projects/CMIP5_p50/MPI/${species}/p50depth

  echo "SET DATA \"/Data/CMIP5/climdiff/WOA_modeldiff_rcp8.5/MPI_rcp8.5_po2.nc\", \"/Data/CMIP5/climdiff/WOA_modeldiff_rcp8.5/MPI_rcp8.5_temp.nc\"" >p50depth.jnl
  ...
  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/MPI/${species}/p50/mpi.rcp85.p50.${species}.nc\"/LLIMITS=1:12/L=1 p50" >> p50depth.jnl

  echo "repeat/L=2:12 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/MPI/${species}/p50/mpi.rcp85.p50.${species}.nc\"/L=\`l\` p50)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/MPI/${species}/p50depth/mpi.rcp85.p50depth.${species}.nc\"/LLIMITS=1:12/L=1 p50depth" >> p50depth.jnl

  echo "repeat/L=2:12 (SAVE/APPEND/FILE=\"/Data/Projects/CMIP5_p50/MPI/${species}/p50depth/mpi.rcp85.p50depth.${species}.nc\"/L=\`l\` p50depth)" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/MPI/${species}/p50/mpi.rcp85.p50av.${species}.nc\" p50av" >> p50depth.jnl

  echo "SAVE/CLOBBER/FILE=\"/Data/Projects/CMIP5_p50/MPI/${species}/p50depth/mpi.rcp85.p50depthav.${species}.nc\" p50depthav" >> p50depth.jnl
