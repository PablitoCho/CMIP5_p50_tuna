...
while i<len(species1):
  file = Folder + species1[i] + '/p50depthav/esm2m.rcp85.2081-2100.p50depthav.' + species1[i] + '.nc'
  nc = Dataset(file,'r')
  ...
  plt.suptitle("ESM2M RCP8.5 2081-2100 P50 Depth")
  i=i+1

plt.show()

outfig = '/Users/kasmith/Dropbox/Manuscripts/CMIP5_p50/Graphs/ESM2M.rcp85.2081-2100.p50depthav.species1.ps'
plt.savefig(outfig, dpi=300, bbox_inches=0)


i = 0
while i<len(species2):
  file = Folder + species2[i] + '/p50depthav/esm2m.rcp85.2081-2100.p50depthav.' + species2[i] + '.nc'
  nc = Dataset(file,'r')
  lats = nc.variables['YT_OCEAN'][:]
  lons = nc.variables['XT_OCEAN'][:]
  lons2 = lons+360
...
outfig = '/Users/kasmith/Dropbox/Manuscripts/CMIP5_p50/Graphs/ESM2M.rcp85.2081-2100.p50depthav.species2.ps'
plt.savefig(outfig, dpi=300, bbox_inches=0)


i = 0
while i<len(species3):
  file = Folder + species3[i] + '/p50depthav/esm2m.rcp85.2081-2100.p50depthav.' + species3[i] + '.nc'
  nc = Dataset(file,'r')
  lats = nc.variables['YT_OCEAN'][:]
  lons = nc.variables['XT_OCEAN'][:]
  lons2 = lons+360
...
outfig = '/Users/kasmith/Dropbox/Manuscripts/CMIP5_p50/Graphs/ESM2M.rcp85.2081-2100.p50depthav.species3.ps'
plt.savefig(outfig, dpi=300, bbox_inches=0)
