...
Folder = '/Data/Projects/CMIP5_p50/cesm1/'
...
while i<len(species1):
  file = Folder + '/' + species1[i] + '/deltap50depth/cesm1.deltap50depthav.' + species1[i] + '.nc'
  nc = Dataset(file,'r')
  ...
  plt.suptitle("CESM1 P50 Depth Change")
  i=i+1

plt.show()

outfig = '/Users/kasmith/Code/Projects/CMIP5_p50/graphs/cesm1_deltap50depthav.ps'
