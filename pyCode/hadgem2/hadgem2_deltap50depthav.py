...
Folder = '/Data/Projects/CMIP5_p50/hadgem2/'
...
while i<len(species1):
  file = Folder + '/' + species1[i] + '/deltap50depth/hadgem2.deltap50depthav.' + species1[i] + '.nc'
  nc = Dataset(file,'r')
  ...
  plt.suptitle("HadGEM2 P50 Depth Change")
  i=i+1

plt.show()

outfig = '/Users/kasmith/Code/Projects/CMIP5_p50/graphs/hadgem2_deltap50depthav.ps'
