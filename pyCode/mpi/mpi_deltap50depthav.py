...
Folder = '/Data/Projects/CMIP5_p50/mpi/'
...
while i<len(species1):
  file = Folder + '/' + species1[i] + '/deltap50depth/mpi.deltap50depthav.' + species1[i] + '.nc'
  nc = Dataset(file,'r')
  ...
  plt.suptitle("MPI P50 Depth Change")
  i=i+1

plt.show()

outfig = '/Users/kasmith/Code/Projects/CMIP5_p50/graphs/mpi_deltap50depthav.ps'
