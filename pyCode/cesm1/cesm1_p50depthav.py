...
while i<len(species1):
  file = Folder + species1[i] + '/p50depth/cesm1.rcp85.p50depthav.' + species1[i] + '.nc'
  nc = Dataset(file,'r')
  ...
  plt.suptitle("CESM1 P50 Depth")
  i=i+1

plt.show()

outfig = '/Users/kasmith/Code/Projects/CMIP5_p50/graphs/cesm1_p50depthav.ps'
