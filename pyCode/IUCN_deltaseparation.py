...
file = 'results/IUCN_modelmean/IUCN.modelmean.deltaseparation.nc'
nc = Dataset(file,'r')
...
nsp_cyclic, lons_cyclic = shiftgrid(20.5, nsp, lons, start=True)
...
pylab.text(0.17,-2.5, 'Change in vertical separation', fontsize=12)

outfig = 'graphs/deltaseparation.ps'
